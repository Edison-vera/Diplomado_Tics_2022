...
public class EstudianteDao extends Estudiante {
    ...
    public boolean insert(ConexionDB conn,String cedula, String codigo, String nombre, String apellido, int edad, char sexo, int idFacultad){
        boolean insert = false;
        try {
            String query = "INSERT INTO Estudiantes VALUES(?, ?, ?, ?, ?, ?, ?)";
            PreparedStatement pst = conn.getConexion().prepareStatement(query);
    ...
    public ResultSet selecByCedula(ConexionDB objConn, String cedula){
        ResultSet result = null;
        try {
